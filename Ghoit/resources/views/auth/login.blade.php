<x-guest-layout>
    <div class="mb-8">
        ...
        <p class="text-gray-500 text-sm mt-1">Silakan masukkan kredensial Anda untuk melanjutkan.</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div class="flex items-center">
            ...
            <label for="remember_me" class="ms-2 text-sm text-gray-500 font-medium select-none">Ingat Saya</label>
        </div>
